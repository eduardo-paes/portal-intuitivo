...
class UsersInsert extends Component {
    ...
    handleIncludeUser = async () => {
        ...
        const novoUsuario = { nome, email, acesso };    // Cria novo usuário

        await api.inserirUsuario(novoUsuario).then(res => {
    ...
    render() {
        ...
        return (
            <div className="form-group">
                ...
                <button className="update-btn" onClick={this.handleIncludeUser}>Adicionar</button>
